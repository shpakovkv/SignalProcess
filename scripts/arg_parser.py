...
def get_utility_args_parser():
    """Returns the parser of parameters of save data.

    :return: file save arguments parser
    :rtype: argparse.ArgumentParser
    """
    utility_params_parser = argparse.ArgumentParser(add_help=False)
...
def get_analysis_args_parser():
    """Returns analysis function options parser.

    :return: analysis arguments parser
    :rtype: argparse.ArgumentParser
    """
    ...
    analysis_parser.add_argument(
        ...
        help='Calculates correlation function for two selected curves. \n'
             ...
             'NOTES: Curves generated by "correlate" option will be added \n'
             '       before curves generated by "correlate_part" option!\n\n')

    analysis_parser.add_argument(
        '--correlate-part',
        action='append',
        metavar=('CURVE1', 'LEFT1', 'RIGHT1', 'CURVE2', 'LEFT2', 'RIGHT2', 'ADD?'),
        nargs=7,
        type=float,
        dest='correlate_part',
        default=None,
        help='Calculates the correlation function for two intervals\n'
             'of the selected curves. \n'
             'Specify the index of the FIRST curve, \n'
             'as well as the left and right boundaries \n'
             'of the processed interval (enter value in time units). \n'
             'Specify the index of the SECOND curve, \n'
             'as well as the left and right boundaries \n'
             'of it\'s interval (enter value in time units). \n'
             'Then enter 1 to add the correlation function \n'
             'to the signals data as a new curve,\n'
             'OR enter 0 to not add the calculated data to signals.\n'
             'NOTES: Curves generated by "correlate_part" option will be\n'
             '       added after curves generated by "correlate" option!'
             'NOTES: to process the entire curve, enter the same value\n'
